...
const space_loading = ref<boolean>(false)
const fetchSpaceDetail = async () => {
  space_loading.value = true
  try {
...
const picture_loading = ref<boolean>(false)

const fetchPictureVOList = async () => {
  picture_loading.value = true
  // 搜索参数转换
  const param = {
    spaceId: props.id,
    ...searchParams.value,
...
const onSearch = async (params: API.PictureQueryRequest) => {
  picture_loading.value = true
