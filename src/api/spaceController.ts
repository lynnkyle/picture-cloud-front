...
export async function editSpace(body: API.SpaceEditRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseLong>('/space/edit', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listSpaceByPage(
  ...
  return request<API.BaseResponseIPageSpace>('/space/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listSpaceVoByPage(
  ...
  return request<API.BaseResponseIPageSpaceVO>('/space/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function updateSpace(body: API.SpaceUpdateRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseLong>('/space/update', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
